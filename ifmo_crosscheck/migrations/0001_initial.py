...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ifmo_crosscheck_submission', (
        ...
        db.send_create_signal('ifmo_crosscheck', ['Submission'])

        # Adding model 'Score'
        db.create_table('ifmo_crosscheck_score', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ifmo_crosscheck.Submission'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('score', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('ifmo_crosscheck', ['Score'])


    def backwards(self, orm):
        # Deleting model 'Submission'
        db.delete_table('ifmo_crosscheck_submission')

        # Deleting model 'Score'
        db.delete_table('ifmo_crosscheck_score')
