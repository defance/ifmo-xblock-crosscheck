...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.size'
        db.add_column('ifmo_crosscheck_submission', 'size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.size'
        db.delete_column('ifmo_crosscheck_submission', 'size')
