...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.mimetype'
        db.add_column('ifmo_crosscheck_submission', 'mimetype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.mimetype'
        db.delete_column('ifmo_crosscheck_submission', 'mimetype')
